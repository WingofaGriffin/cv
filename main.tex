...
\item Built interface to show status of canteens. Large focus on UX.
\end{itemize}
\divider

\cvevent{Reseach Assistant}{University of California San Francisco}{May 2016 -- August 2016}{San Francisco, CA}
\begin{itemize}
\item Developed and bug tested Unity software for Kinect.
\item Worked with researchers to modernize their software and technology.
\end{itemize}
\begin{comment}
\cvsection{Projects}
...
\wheelchart{1.5cm}{0.5cm}{%
  ...
  7/10em/accent!55/Advocating to Developers,
