...
\tagline{Solutions Engineer \& Developer Advocate}
%\photo{2.8cm}{griffin}
\personalinfo{%
...
\cvevent{Solutions Engineer}{Datadog}{April 2020 -- Present}{San Francisco, CA / Remote}
\begin{itemize}
\item Respond to client requests on fast paced team while continuing to educate clients on use of the platform.
\item Reproduce issues and dive into the 400+ integrations and platforms that Datadog works with and provide demos for potential customers.
\item Built out documentation and knowledge based articles for a variety of technology and created internal tools for improved team efficiency.
\end{itemize}
\divider
...
\cvevent{Developer Evangelist Intern}{DocuSign}{May 2018 -- August 2018}{San Francisco, CA}
\begin{itemize}
...
\cvevent{Co-Chair}{Yale Spring Fling}{May 2017 -- May 2018}{New Haven, CT}
\begin{itemize}
